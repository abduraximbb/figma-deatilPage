  ...
  return (
    <header id='header' className='max-[750px]:px-3'>
      <nav className='container h-[60px] flex items-center justify-between'>
        ...
        <ul style={{display: show ? "flex" : "hide"}} className={`flex gap-10 max-[750px]:absolute max-[750px]:top-[60px] max-[750px]:left-0 max-[750px]:flex-col max-[750px]:bg-white max-[750px]:shadow-md max-[750px]:w-full max-[750px]:p-5 max-[750px]:gap-3 `} >
          <li>
